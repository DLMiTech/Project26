...
const Register = () => {
    ...
    const [formData01, setFormData01] = useState({email:"", name:"", phone: "", password:""})
                ...
                <div className="auth-form-wrapper">
                    ...
                    <div className="top-row">
                        <div>
                            ...
                            <p className={`sub-tittle`}>Create an account to join us</p>
                        </div>
                    ...
                    <form onSubmit={handleSubmitRegister}>
                        ...
                        <div className="custom-input">
                            ...
                            <div className="input-box">
                                <i className="ri-phone-line left-icon"></i>
