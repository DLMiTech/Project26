...
const Admin = () => {
    ...
    const fetchAccess = useCallback(async () => {
        ...
        try {
            const res = await AccessRequest.getAllAccess();
        ...
        <div className="card">
            ...
            <div className="card-header">
                <div className="d-flex justify-content-between align-items-center">
                    <div className="">
                        <h3 className="mb-0">All Pending Access</h3>
                        <small>Select one and grant access or decline</small>
                    </div>

                    <Link to={`/access-control/get-all`} className={`btn btn-sm btn-outline-primary`}>All Access</Link>
                </div>
            </div>
